...
user = np.array(['Garvita', 'Kesarwani'])  # User id
...
if u == user[0] and p == pin[0] and a == ac[0]:
    ...
    print("***************************************")
    print("*                                     *")
    print("*****WELCOME GARVITA TO ATM SYSTEM*****")
    print("*                                     *")
    print("***************************************")
    print("\n   How can we Help You:")
    ...
    if choice == 1:
        ...
        if u == user[0]:
            ...
            if choice == 1:
                ...
                if o == OTP[0]:
                    print(
                        "Password has been successfully!!! sent to your Mobile number, please Remember your Password for Future Reference\nPlease Login Again if you want to perform Another Task")
                else:
                    print("Incorrect OTP\nPlease Login Again")
            elif choice == 2:
                ...
                if o == OTP[0]:
                    print(
                        "Password has been successfully!!! sent to your Email id, please Remember your Password for Future Reference\nPlease Login Again if you want to perform Another Task")
                else:
                    print("Incorrect OTP\nPlease Login Again")
            else:
    ...
    print("**************************************")
    print("*                                    *")
    print("***WELCOME KESARWANI TO ATM SYSTEM****")
    print("*                                    *")
    print("**************************************")
    print("\n   How can we Help You:")
    print("    1)Balance Enquiry\n    2)Cash Withdrawl\n    3)Forget Password\n    4)Logout")
